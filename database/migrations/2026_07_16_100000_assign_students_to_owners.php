...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($districtId) {
            DB::table('students')->whereNull('created_by')->update(['created_by' => $districtId]);
        }
    }
